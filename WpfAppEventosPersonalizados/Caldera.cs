...
namespace WpfAppEventosPersonalizados
{
    internal class Caldera
    {
        ...
        public int Temperatura
        {
            ...
            {
                temperatura = value;
                if (temperatura > 99) { StopCaldera?.Invoke(this, EventArgs.Empty); }
                if (temperatura < 60) { Estado = Estados.Correcto; }
                else if (temperatura < 80) { Estado = Estados.Alerta; }
                else { Estado = Estados.Peligro; }
                CambioTemperatura?.Invoke(this, new CalderaArgumentosEvento(temperatura, DateTime.Now, estado));
            }
        }
        ...
        public Estados Estado
        {
            ...
            private set
            {
                ...
                {
                    estado = value;
                    CambioEstado?.Invoke(this, new CalderaArgumentosEvento(temperatura, DateTime.Now, estado));
                }
            }
        }
    }
